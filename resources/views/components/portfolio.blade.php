    ...
    <div class="container mx-auto px-4">
        ...
        <div class="text-center mb-16">
            <h2 class="text-4xl md:text-5xl font-bold text-white mb-6">
                Featured <span class="text-bright-indigo">Projects</span>
            </h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-slate-900/80 backdrop-blur-sm border border-slate-700 rounded-xl overflow-hidden hover:border-bright-indigo transition-all duration-300 group">
                ...
                <div class="p-6">
                    ...
                    <p class="text-gray-300 mb-4">
                        Created a comprehensive telemedicine solution connecting patients with healthcare providers through secure video consultations and health monitoring.
                    </p>
                    <div class="flex flex-wrap gap-2 mb-4">
